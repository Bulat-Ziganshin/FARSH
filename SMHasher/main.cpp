...
HashInfo g_hashes[] =
{
  ...
  { ZZH32a_test,          32, 0x44A367B4, "ZZH32a",      "zzHash, second 32 bits of result" },
  { ZZH32b_test,          32, 0x44A367B4, "ZZH32b",      "zzHash, third 32 bits of result" },
  { ZZH32c_test,          32, 0x44A367B4, "ZZH32c",      "zzHash, thourth 32 bits of result" },
  { ZZH64_test,           64, 0xFA028F55, "ZZH64",       "zzHash, 64-bit result" },
  { ZZH64a_test,          64, 0xFA028F55, "ZZH64a",      "zzHash, upper 64-bit result" },
  { ZZH128_test,         128, 0xFA028F55, "ZZH128",      "zzHash, 128-bit result" },
